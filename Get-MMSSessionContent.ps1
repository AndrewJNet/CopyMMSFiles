...
Param(
  ...
  [ValidateSet("2015", "2016", "2017", "2018", "de2018", "2019", "jazz", "miami", "2022atmoa", "2023atmoa")]
  [string]$ConferenceId,
...
$PrivateContentYears = @('2018', 'de2018', '2019', 'jazz', 'miami', '2022atmoa', '2023atmoa')
...
$ConferenceYears | ForEach-Object -Process {
  ...
  if ($creds) {
    ...
    # SEND IT
    $web = Invoke-WebRequest $SchedLoginURL -WebSession $mms -Method POST -Body $body
